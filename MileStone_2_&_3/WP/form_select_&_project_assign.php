...
<div class="body">			
        ...
        <h3>This Form Allows the User to Input Critea for Selection/Projection</h3>
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            echo "<p>If info enetered does not match database there will be no information found.</p></br>";
            echo "<table border = '3'>";
            echo "<tr>
						<td>ProjectID</td>
        ...
        <form method="POST">
            <p>Project ID <input type="text" name="ProjectID" /><span><?php echo $projIdErr; ?></span></p>
            <p>Employee Number <input type="text" name="EmployeeNumber" /><span><?php echo $empErr; ?></span></p>
            <p>Hours Worked <input type="text" name="HoursWorked" /><span><?php echo $hoursErr; ?></span></p>
